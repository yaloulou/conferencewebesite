    ...
    const handlePayment = async (e) => {
      ...
      try {
        ...
        if (paymentMethod === "mobile") {
          ...
          payload = {
            RequestData: {
              Amount: (parseInt(formData.amount) * 100).toString(),
          ...
          payload = {
            ...
            Language: "en",
            Reference: formData.reference,
            SuccessURL: "https://www.drcdigitalhorizon.org/success",
            FailureURL: "https://www.drcdigitalhorizon.org/failure",
            CancelURL: "https://www.drcdigitalhorizon.org/cancel",
            NotifyURL: "https://www.drcdigitalhorizon.org/notify",
            FirstName: formData.firstName,
            LastName: formData.lastName,
            Email: formData.email,
            cData: {
