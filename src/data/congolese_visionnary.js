const congoleseVisionnary = [
  // Thierry KATEMBWE MBALA (ID: 111)
  {
    ...
    avatar: "/intervenants/Thierry Katembwe.png",
    social: {
      twitter: null,
      linkedin: null
    }
  ...
  // Jean Pierre Nzuru (ID updated to 114)
  {
    id: 114, 
  ...
  // Kyandoghere Kyamakya (ID updated to 116)
  {
    id: 116, 
  ...
  // Freddy Bangelesa (ID: 108 - Original ID kept)
  {
    id: 108,
    name: "Freddy Bangelesa",
    title: "Professor, School of Public Health, Kinshasa & Senior Researcher, German National Weather Service",
  ...
  // Moussa Musavuli Mbutho (ID: 110 - Original ID kept)
  {
    id: 110,
  ...
  // Placeholder (ID: 997 - Original ID kept)
  {
    id: 997,
